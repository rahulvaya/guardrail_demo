...
//       * hosts the Azure OpenAI deployment (`*.openai.azure.com`)
//   - Azure OpenAI gpt-4o-mini model deployment on the AI Services account
//   - AKS cluster:
...
@description('Azure AI Services (multi-service) account name. Hosts Content Safety, Language, and Azure OpenAI.')
